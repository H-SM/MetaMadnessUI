...
const InsightCard = ({ imgUrl , title, subtitle, index}) => (
  ...
  className='flex md:flex-row flex-col gap-4'>
    <img src={imgUrl} alt="plnt" className='md:w-[270px] w-full h-[250px] rounded-[32px] object-cover'/>
    <div className='w-full flex justify-between items-center'>
      <div className='flex-1 md:ml-[62px] flex flex-col max-w-[650px]'>
        <h4 className='font-normal lg:text-[42px] text-[26px] text-white'>{title}</h4>
        <p className='mt-[16px] font-normal lg:text-[20px] text-[15px] text-secondary-white'>{subtitle}</p>
      </div>
