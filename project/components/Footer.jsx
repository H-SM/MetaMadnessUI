    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
        <div className="flex items-center justify-between flex-wrap gap-5">
          ...
          <button type="button" className="flex items-center h-fit py-4 px-6 bg-[#25618b] rounded-[32px] gap-[12px]">
            <img src="/headset.svg" alt="hdset" className="w-[24px] h-[24px] object-contain"/>
        ...
        <div className="flex- flex-col ">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex gap-4">
              {socials.map((social) => (<img key={social.name} src={social.url} alt="scl" className="w-[24px] h-[24px] object-contain cursor-pointer bg-blend-color-burn"/>))}
            </div>
